...
import habitat_baselines.rl.ddppo.policy.vit_models.configs as configs
...
class VisionTransformer(nn.Module):
    def __init__(self, config=CONFIGS["ViT-B_16"], img_size=224, num_classes=21843, zero_head=False, vis=False):
